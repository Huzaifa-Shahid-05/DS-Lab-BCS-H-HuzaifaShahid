#pragma once
//write isvalidLocation function
//initializse location in graph array locations
// write delivery user menu
//hashmap for delivery rider
...
public:
    ...
    Graph(int vertices) : numVertices(vertices) {
        ...
        locationNames[0] = "CliftonBlock1";   
        locationNames[1] = "CliftonBlock2";   
        locationNames[2] = "DefencePhase2";
        locationNames[3] = "DefencePhase5";  
        locationNames[4] = "DHAPhase6";  
        locationNames[5] = "DHAPhase7";
        locationNames[6] = "Saddar";   
        locationNames[7] = "TariqRoad";   
        locationNames[8] = "Bahadurabad";
        locationNames[9] = "GulshanBlock3";   
        locationNames[10] = "GulshanBlock5";  
        locationNames[11] = "GulshanBlock10";
        locationNames[12] = "JauharBlock12"; 
        locationNames[13] = "JauharBlock15"; 
        locationNames[14] = "NazimabadBlock2";
        locationNames[15] = "NazimabadBlock4";  
        locationNames[16] = "NorthNazimabadBlockA";  
        locationNames[17] = "NorthNazimabadBlockH";
        locationNames[18] = "Korangi1"; 
        locationNames[19] = "Korangi2"; 
        locationNames[20] = "Korangi5";
        locationNames[21] = "Landhi3"; 
        locationNames[22] = "Landhi5";  
        locationNames[23] = "PECHSBlock2";
        locationNames[24] = "PECHSBlock6"; 
        locationNames[25] = "FBAreaBlock10"; 
        locationNames[26] = "FBAreaBlock14";
        locationNames[27] = "MalirCanttCheckpost2";


        // Now you can add the edges based on the given data
        addEdge("CliftonBlock1", "CliftonBlock2", 11);
        addEdge("DefencePhase2", "DefencePhase5", 6);
        addEdge("DHAPhase6", "DHAPhase7", 5);
        addEdge("Saddar", "PECHSBlock6", 7);
        addEdge("TariqRoad", "Bahadurabad", 11);
        addEdge("DHAPhase7", "GulshanBlock3", 2);
        addEdge("GulshanBlock5", "GulshanBlock10", 9);
        addEdge("JauharBlock12", "DHAPhase7", 14);
        addEdge("CliftonBlock2", "JauharBlock15", 12);
        addEdge("Bahadurabad", "NazimabadBlock2", 15);
        addEdge("JauharBlock12", "Bahadurabad", 7);
        addEdge("NazimabadBlock4", "FBAreaBlock10", 2);
        addEdge("DHAPhase7", "GulshanBlock5", 14);
        addEdge("TariqRoad", "NorthNazimabadBlockA", 3);
        addEdge("DHAPhase6", "DefencePhase5", 1);
        addEdge("NorthNazimabadBlockA", "JauharBlock12", 2);
        addEdge("Bahadurabad", "NorthNazimabadBlockH", 9);
        addEdge("TariqRoad", "Korangi5", 3);
        addEdge("CliftonBlock1", "FBAreaBlock14", 6);
        addEdge("PECHSBlock6", "Landhi3", 4);
        addEdge("Landhi5", "Landhi3", 7);
        addEdge("NorthNazimabadBlockA", "NazimabadBlock4", 10);
        addEdge("Korangi1", "NorthNazimabadBlockA", 5);
        addEdge("Landhi3", "Korangi2", 12);
        addEdge("Korangi5", "GulshanBlock3", 15);
        addEdge("DefencePhase2", "DHAPhase6", 13);
        addEdge("GulshanBlock5", "DHAPhase7", 1);
        addEdge("JauharBlock15", "PECHSBlock6", 2);
        addEdge("FBAreaBlock14", "DefencePhase2", 5);
        addEdge("Korangi5", "NorthNazimabadBlockH", 14);
        addEdge("DefencePhase2", "GulshanBlock5", 3);
        addEdge("DHAPhase7", "PECHSBlock2", 6);
        addEdge("PECHSBlock2", "GulshanBlock5", 7);
        addEdge("Saddar", "DefencePhase5", 11);
        addEdge("GulshanBlock5", "TariqRoad", 12);
        addEdge("PECHSBlock2", "Saddar", 4);
        addEdge("DHAPhase7", "PECHSBlock6", 3);
        addEdge("PECHSBlock6", "JauharBlock12", 5);
        addEdge("GulshanBlock10", "MalirCanttCheckpost2", 8);
        addEdge("NazimabadBlock2", "Bahadurabad", 10);
        addEdge("Landhi5", "FBAreaBlock14", 9);
